  ...
  return (
    <div >
      ...
      <div className="flex flex-col items-center bg-gray-200 p-6">
        <h1 className="text-3xl font-semibold text-center text-gray-800 mt-4 mb-6 border-b-2 border-gray-800">
          ROLLS ROYCE 2025 Price in Pakistan, Images, Reviews & Specs
        </h1>
...
<div className="mt-6">
  <span className="text-green-600 font-sans text-4xl block mb-4">PKR 27.62 CRORE</span>
