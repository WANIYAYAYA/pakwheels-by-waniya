...
<div className="mt-6">
  <span className="text-green-600 font-sans text-4xl block mb-4">PKR 11,500,000</span>
 <Link href={"/form"}><button className="bg-blue-600 text-white rounded-md px-8 py-3 ml-8 mt-4 hover:bg-blue-700">
    Make Payment
  </button></Link>
</div>
      </div>
