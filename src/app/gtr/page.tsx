  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center bg-gray-200 p-6">
        <h1 className="text-3xl font-semibold text-center border-b-2 border-gray-800 text-gray-800 mt-4 mb-6">
          NISSAN GTR R-34 2025 Price in Pakistan, Images, Reviews & Specs
        </h1>
